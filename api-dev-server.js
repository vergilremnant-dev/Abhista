...
import categoriesTreeHandler from './api/categories/tree.js';
import categoriesFeaturedHandler from './api/categories/featured.js';
import categoriesReorderHandler from './api/categories/reorder.js';
...
import complianceHandler from './api/compliance/index.js';
...
import uploadHandler from './api/profile/upload.js';
import completionHandler from './api/profile/completion.js';
...
import searchIndexHandler from './api/search/index.js';
import searchProvidersHandler from './api/search/providers.js';
import searchFeaturedHandler from './api/search/featured.js';
import searchRecommendedHandler from './api/search/recommended.js';
import searchRecommendationsHandler from './api/search/recommendations.js';
import searchSuggestionsHandler from './api/search/suggestions.js';
import requirementsIndexHandler from './api/requirements/index.js';
import requirementsMyHandler from './api/requirements/my.js';
import requirementsDetailHandler from './api/requirements/[id]/index.js';
import requirementsStatusHandler from './api/requirements/[id]/status.js';
import requirementsNotesHandler from './api/requirements/[id]/notes.js';
import requirementsAttachmentsHandler from './api/requirements/[id]/attachments.js';
import quotationsIndexHandler from './api/quotations/index.js';
import quotationsCompareHandler from './api/quotations/compare.js';
import quotationsDetailHandler from './api/quotations/[id]/index.js';
import quotationsStatusHandler from './api/quotations/[id]/status.js';
import quotationsNegotiateHandler from './api/quotations/[id]/negotiate.js';
import quotationsReviseHandler from './api/quotations/[id]/revise.js';
import projectsIndexHandler from './api/projects/index.js';
import projectsDetailHandler from './api/projects/[id]/index.js';
import projectsWorkOrdersHandler from './api/projects/[id]/work-orders.js';
import projectsMilestonesHandler from './api/projects/[id]/milestones.js';
import projectsResourcesHandler from './api/projects/[id]/resources.js';
import projectsProgressHandler from './api/projects/[id]/progress.js';
import projectsApprovalsHandler from './api/projects/[id]/approvals.js';
import appointmentsIndexHandler from './api/appointments/index.js';
import appointmentsAvailabilityHandler from './api/appointments/availability.js';
import appointmentsDetailHandler from './api/appointments/[id]/index.js';
import appointmentsStatusHandler from './api/appointments/[id]/status.js';
...
import conversationsIndexHandler from './api/conversations/index.js';
import conversationsPresenceHandler from './api/conversations/presence.js';
import conversationsDetailHandler from './api/conversations/[id]/index.js';
import conversationsMessagesHandler from './api/conversations/[id]/messages.js';
import conversationsReadHandler from './api/conversations/[id]/read.js';
import activitiesIndexHandler from './api/activities/index.js';
import announcementsIndexHandler from './api/announcements/index.js';
import workforceTypesHandler from './api/workforce/types.js';
import workforceCategoriesHandler from './api/workforce/categories.js';
...
import subscriptionsCreateOrderHandler from './api/subscriptions/create-order.js';
import subscriptionsVerifyPaymentHandler from './api/subscriptions/verify-payment.js';
...
import providerDashboardIndexHandler from './api/provider/dashboard/index.js';
import providerPerformanceHandler from './api/provider/performance/index.js';
import providerCalendarIndexHandler from './api/provider/calendar/index.js';
import providerCalendarBlockedDatesHandler from './api/provider/calendar/blocked-dates.js';
import providerCalendarAvailabilityHandler from './api/provider/calendar/availability.js';

// Reviews Handler Imports
import publicReviewsListHandler from './api/providers/[id]/reviews.js';
import publicRatingSummaryHandler from './api/providers/[id]/rating-summary.js';
import customerReviewsIndexHandler from './api/reviews/index.js';
import customerReviewsMyHandler from './api/reviews/my.js';
import customerReviewsDetailHandler from './api/reviews/[id]/index.js';
import providerReviewsReplyHandler from './api/provider/reviews/[id]/reply.js';
import providerReviewsIndexHandler from './api/provider/reviews/index.js';
import adminReviewsIndexHandler from './api/admin/reviews/index.js';
import adminReviewsHideHandler from './api/admin/reviews/[id]/hide.js';
import adminReviewsRestoreHandler from './api/admin/reviews/[id]/restore.js';
import adminReviewsDetailHandler from './api/admin/reviews/[id]/index.js';

// Articles Handler Imports
import publicArticlesIndexHandler from './api/articles/index.js';
import publicArticlesFeaturedHandler from './api/articles/featured.js';
import publicArticlesDetailHandler from './api/articles/[slug].js';
import publicArticlesCategoryHandler from './api/articles/category/[slug].js';
import publicArticlesCategoriesHandler from './api/articles/categories.js';
import publicArticlesTrackHandler from './api/articles/[id]/track.js';
import adminArticlesIndexHandler from './api/admin/articles/index.js';
import adminArticlesDetailHandler from './api/admin/articles/[id].js';
import adminArticlesCategoriesIndexHandler from './api/admin/categories/index.js';
import adminArticlesCategoriesDetailHandler from './api/admin/categories/[id].js';
import adminArticlesAnalyticsHandler from './api/admin/articles/analytics.js';

// Admin Analytics Handler Imports
import adminAnalyticsOverviewHandler from './api/admin/analytics/overview.js';
import adminAnalyticsBookingsHandler from './api/admin/analytics/bookings.js';
import adminAnalyticsProvidersHandler from './api/admin/analytics/providers.js';
import adminAnalyticsCustomersHandler from './api/admin/analytics/customers.js';
import adminAnalyticsSubscriptionsHandler from './api/admin/analytics/subscriptions.js';
import adminAnalyticsConsultationsHandler from './api/admin/analytics/consultations.js';
import adminAnalyticsCallbacksHandler from './api/admin/analytics/callbacks.js';
import adminAnalyticsContentHandler from './api/admin/analytics/content.js';

// New Admin Handler Imports
import adminUsersIndexHandler from './api/admin/users/index.js';
import adminUsersDetailHandler from './api/admin/users/[id].js';
import adminProvidersIndexHandler from './api/admin/providers/index.js';
import adminSubscriptionsIndexHandler from './api/admin/subscriptions/index.js';

// Chat Handler Imports
import chatConversationsIndexHandler from './api/chat/conversations/index.js';
import chatConversationsDetailHandler from './api/chat/conversations/[id].js';
import chatMessagesIndexHandler from './api/chat/messages/index.js';
import chatMessagesFetchHandler from './api/chat/messages/[conversationId].js';
import chatMessagesReadHandler from './api/chat/messages/[id]/read.js';
