...
import { completeConsultation } from '../../../../api-lib/services/consultationService.js';
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  if (method === 'PATCH') {
    try {
      const updated = await completeConsultation(paramId, user.id, req.body.providerNotes);
