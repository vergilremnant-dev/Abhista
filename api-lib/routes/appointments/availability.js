...
import { getProviderAvailableSlots, setProviderAvailabilityBlocks } from '../../services/appointmentService.js';
export default async function handler(req, res) {
    ...
    try {
        if (method === 'GET') {
            ...
            const slots = await getProviderAvailableSlots(providerId, new Date(date));
