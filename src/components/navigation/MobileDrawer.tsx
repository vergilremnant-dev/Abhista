          ...
          <div className="space-y-3 pt-4 border-t border-stone-100">
            ...
            {user ? (
              ...
              <Link
                to="/login"
                onClick={onClose}
                className="block w-full text-center py-2.5 bg-emerald-700 text-white rounded-xl text-xs font-bold uppercase tracking-wider transition hover:bg-emerald-800 shadow-xs"
              >
                Sign In
              </Link>
            )}
