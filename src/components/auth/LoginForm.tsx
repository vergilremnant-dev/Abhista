  ...
  return (
    <div className="space-y-4 text-left">
      ...
      <form onSubmit={onSubmit} className="space-y-3.5">
        ...
        {/* Email Field */}
        <div>
          <label htmlFor="login-email" className="block text-[10px] font-black uppercase tracking-wider text-stone-500 mb-1">
            Email Address
          </label>
          <input
            id="login-email"
      ...
      <div className="relative flex items-center justify-center my-3">
        ...
        <span className="relative bg-white px-3 text-[9px] font-bold uppercase tracking-widest text-stone-400">
          Or continue with
        </span>
      </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        >
          ...
          <span className="text-[10px] font-bold text-stone-700">Google</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-bold text-stone-700">Microsoft</span>
        </button>
        ...
        >
          ...
          <span className="text-[10px] font-bold text-stone-700">Apple</span>
        </button>
      </div>
